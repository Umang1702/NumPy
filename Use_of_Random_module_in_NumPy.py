...
print("\n")
# The output of the rand() function gives the value or elements betweem 0 and 1.
...
print("\n")
# The output of the randn() function gives the value or elements which is close to zero.

# Use of randf() function of Random module:-
variable3=np.random.ranf(5)  # Use The ranf() function of the Random module.
...
variable4=np.random.randint(1,20,10)  # Use The randint() function of the Random module.
